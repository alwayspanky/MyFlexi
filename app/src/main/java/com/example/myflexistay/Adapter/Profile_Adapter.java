...
public class Profile_Adapter extends RecyclerView.Adapter<Profile_Adapter.profileholder> {
    ...
    ArrayList<ProfileModel.Profile_screen> profileScreenArrayList;

    public Profile_Adapter(Context context, ArrayList<ProfileModel.Profile_screen> profileScreenArrayList) {
    ...
    public void onBindViewHolder(@NonNull profileholder holder, int position) {
        ...
        ProfileModel.Profile_screen profile = profileScreenArrayList.get(position);
