...
public class PropertyDetailsFragment1 extends Fragment {
    ...
    private EditText edtApartment, edt_facing, edt_bhk, edt_property_age, edt_floor1, edt_floor2, edt_apartment_name, water_supply;
    LinearLayout view;
    boolean opened;
    TextView selectDropDownName;
    RecyclerView recyclerView;
    String SelectedPropertyName;
    String SelectedBhkname;
    String SelectedPropertyAge;
    String SelectWaterSupply;
...
//                Log.d(TAG , "onClick: apartment");
        ...
        edt_property_age.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectDropDownName.setText("Select property age");
        ...
        edt_facing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectDropDownName.setText("Select facing type");
        ...
        water_supply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectDropDownName.setText("Select Water Supply");
                hideKeyBoard(water_supply);
                apiClient.apiInterface.getWaterSupply().enqueue(new Callback<WaterSupply>() {
                    ...
                    public void onResponse(Call<WaterSupply>call, Response<WaterSupply> response) {
                        if (response.isSuccessful()){
                            waterSupplyArrayList.clear();
                            waterSupplyArrayList.addAll(response.body().getWater_supplies());
                            //Log.d("TAG", "onResponse: "+response.body().getTypes().get(0).getName());
                            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                            WaterSupply_Adapter waterSupplyAdapter = new WaterSupply_Adapter(getActivity(),waterSupplyArrayList);
                            recyclerView.setAdapter(waterSupplyAdapter);
                            waterSupplyAdapter.notifyDataSetChanged();
                            waterSupplyAdapter.setOnOrderClickedListener(new AdapterListener4());
                        }
    ...
    private class AdapterListener4 implements WaterSupply_Adapter.onOrderClickedListener{

        @Override
        public void onOrderClickedListener(WaterSupply.water_supply waterSupply) {
            SelectWaterSupply = waterSupply.getName();
            Log.d("TAG", "onOrderClickedListener: " + SelectWaterSupply);
            water_supply.setText(SelectWaterSupply);
            Functioncalling();
