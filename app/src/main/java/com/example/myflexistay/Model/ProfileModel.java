...
public class ProfileModel {
    ...
    ArrayList<ProfileModel.Profile_screen> profile_screens;
    ...
    public ArrayList<ProfileModel.Profile_screen> getProfile_screens() {
        return profile_screens;
    }

    public void setProfile_screens(ArrayList<ProfileModel.Profile_screen> profile_screens) {
